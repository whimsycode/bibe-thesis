...
#def count(finalcount):
#    finalcount = detect_video.peoplecountingprocess()
#    return render_template(finalcount=finalcount)
...
if __name__ == '__main__':
    try:
        app.run(host='192.168.254.103', port='5000',debug=True)
    except SystemExit:
        pass
